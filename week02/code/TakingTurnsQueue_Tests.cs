...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The people added initially will keep cycling through the queue until their turns are exhausted, while the new person won't get a turn until the first batch is done.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson method. While it checks for turns being greater than 1 before decrementing, it doesn't handle infinite turns correctly.
